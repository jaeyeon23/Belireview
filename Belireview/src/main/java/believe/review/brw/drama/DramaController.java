	...
	public Map<String,Object> dramaDe(CommandMap commandMap) throws Exception {
		...
		if(comment != null) {
			for(Map m :comment) {
				...
				.append("<em>").append(m.get("DC_LIKE")).append("</em></div>")
				.append("<div class=\"ContentlessCommentItem__UserActionBlock-s1n6rtl6-4 kJvkpH\">")
				.append("<button class=\"ContentlessCommentItem__UserActionButton-s1n6rtl6-5 kRhZsb StylelessButton-phxvo7-0 gsSopE\">좋아요</button>")
				.append("</div></div></li>");
			}
		}
