							...
							<div class="ShrinkHeaderBar__Buttons-kl2m8-1 gvGpvr">
								<div class="ShrinkHeaderBar__LeftButtons-kl2m8-5 dPdGEs">
									<button
										...
										onclick="location.href='/brw/drama/dramaDetail.br?DRAMA_NO=${map.MOVIE_NO}&DRAMA_NAME=${map.MOVIE_NAME}'"></button>
								</div>
							...
							<div class="Row-s1apwm9x-0 lowZpE">
								<ul
									...
									<dl class="ContentOverviewPage__DescriptionList-s3r5qer-1 jnXdZY">
										...
										<dd
											class="ContentOverviewPage__DescriptionDetail-s3r5qer-3 lkqwKE">${map.MOVIE_NAME}</dd>
									</dl>
									<dl class="ContentOverviewPage__DescriptionList-s3r5qer-1 jnXdZY">
										<dt
									...
									<dl class="ContentOverviewPage__DescriptionList-s3r5qer-1 jnXdZY">
										<dt
											...
											연도</dt>
										<dd
											class="ContentOverviewPage__DescriptionDetail-s3r5qer-3 lkqwKE">${map.MOVIE_DATE}</dd>
									</dl>
									<dl class="ContentOverviewPage__DescriptionList-s3r5qer-1 jnXdZY">
										<dt
											class="ContentOverviewPage__DescriptionTitle-s3r5qer-2 dYypmT">국가</dt>
										<dd
											class="ContentOverviewPage__DescriptionDetail-s3r5qer-3 lkqwKE">${map.MOVIE_COUNTRY}</dd>
									</dl>
									<dl class="ContentOverviewPage__DescriptionList-s3r5qer-1 jnXdZY">
										<dt
											class="ContentOverviewPage__DescriptionTitle-s3r5qer-2 dYypmT">장르</dt>
										<dd
											class="ContentOverviewPage__DescriptionDetail-s3r5qer-3 lkqwKE">${map.MOVIE_GENRE}</dd>
									</dl>
									<dl
									...
									<dl class="ContentOverviewPage__DescriptionList-s3r5qer-1 knqOhM">
										...
										<dd
											class="ContentOverviewPage__SummaryDetail-s3r5qer-4 jrdcaY">${map.MOVIE_CONTENT}</dd>
									</dl>
								</ul>
							</div>
						</div>
