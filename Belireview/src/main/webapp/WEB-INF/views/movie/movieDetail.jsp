											...
											<div class="MaxWidthRow-s14yonsc-0 dCZZZZ">
												<div class="MaxWidthCol-s1fpp771-0 bLPhwL">
													<div
														...
														<ul
															class="ContentJumbotron__RankingInfoList-yf8npk-11 fVOUyR">
															<li>예매 순위 · <em>3위(2%)</em></li>
															<li>개봉 · <em>12일째</em></li>
															<li>누적 관객 · <em>215만명</em></li>
														</ul>
													</div>
												</div>
											</div>
											...
											<div class="MaxWidthRow-s14yonsc-0 dCZZZZ">
												<div class="MaxWidthCol-s1fpp771-0 bLPhwL">
													<div class="ContentJumbotron__PaneInner-yf8npk-13 eJceNg">
														<h1 class="ContentJumbotron__Title-yf8npk-14 jCFeyL">사바하</h1>
														<div class="ContentJumbotron__Detail-yf8npk-15 bJHRjP">2019 ・ 스릴러 ・ 한국</div>
														<div class="ContentJumbotron__ContentRatings-yf8npk-16 epsYAr">평점 ★3.4 (3만명)&nbsp;&nbsp;・&nbsp;&nbsp;<em>예상 ★2.7</em>
														</div>
														<div
																		...
																		<ul class="VisualUl-s1vzev56-0 hgAYVH">
																			<li
																				class="ContentReasonSection__ReasonListItem-s1eie0l9-2 ikOkkg"><div
																					class="ContentReasonSection__ReasonTitle-s1eie0l9-3 hOKaLN">선호하는 배우</div>
																				<a lng="ko-KR"
																				class="ContentReasonSection__ReasonLink-s1eie0l9-4 ijHeUQ StylelessLocalLink-s1aqpmgk-1 gdyQIs"
																				href="/ko-KR/people/309471"><div
																						class="ContentReasonSection__ReasonValue-s1eie0l9-5 fIyVCO">이정재</div>
																					<div
																						class="ProfilePhoto__Self-s1v3isfu-1 fAYBdd RoundedImageBlock-k5m4n5-0 gUZYtN">
																						<div
																							class="ProfilePhoto__ProfilePhotoImage-s1v3isfu-0 eaIqOG"></div>
																						<div
																							class="ProfilePhoto__DefaultImageContainer-s1v3isfu-2 kPGxuy">
																							<img
																								class="defaultImage__ProfileImg-s1kn91bx-1 iaxVtx"
															...
															<div class="Grid-zydj2q-0 cspjno">
																<div class="Row-s1apwm9x-0 lowZpE">
																	<article
																		...
																		<div
																			class="ContentOverviewSection__Summary-s1yclw10-1 kdMFQv">
																			사바하<br>
																			<span
																				class="ContentOverviewSection__OverviewMeta-s1yclw10-2 bvwFIW">2019
																				· 한국 · 스릴러</span><br>
																			<span
																				class="ContentOverviewSection__OverviewMeta-s1yclw10-2 bvwFIW">2시간
																				2분</span>
																		</div>
																		<div class="TextTruncate__Self-wvv1uj-0 bzjOJW">
																			<div class="TextTruncate__Text-wvv1uj-1 gLsCNn"
																				style="white-space: pre-line;">신흥 종교 비리를 찾아내는
																				종교문제연구소 ‘박목사’(이정재). 최근 사슴동산이라는 새로운 종교 단체를 조사 중이다. 영월
																				터널에서 여중생이 사체로 발견되는 사건이 발생하고 이를 쫓던 경찰과 우연히 사슴동산에서 마주친
																				박목사는 이번 건이 심상치 않음을 직감한다. 터널...</div>
																		</div>
																	</article>
																	<hr
																		class="Divider__StylingMergedDivider-s11un6bw-1 jtXrQz Divider-s11un6bw-0 cVxSEp">
																			...
																			<div class="Row-s1apwm9x-0 lowZpE">
																				<ul
																						...
																						title="장재현" href="/ko-KR/people/167398"><div
																							...
																							<div
																								...
																								<div
																									...
																									<div
																										class="ListItemWithProfilePhoto__Title-s1a35ruo-1 cSGZfW">장재현</div>
																									<div
																					...
																					<li
																						...
																						lng="ko-KR"
																						class="InnerPartOfListWithImage__LinkSelf-s11a1hqv-1 gmbtJD"
																						title="이정재" href="/ko-KR/people/309471"><div
																								class="InnerPartOfListWithImage__ImageBlock-s11a1hqv-3 kXgAWr">
																								<div
																									class="ProfilePhoto__Self-s1v3isfu-1 cKevdV RoundedImageBlock-k5m4n5-0 gUZYtN">
																									<div
																							...
																							<div
																								...
																								<div
																									class="InnerPartOfListWithImage__Titles-s11a1hqv-4 jtpmaI">
																									<div
																										class="ListItemWithProfilePhoto__Title-s1a35ruo-1 cSGZfW">이정재</div>
																									<div
																										class="ListItemWithProfilePhoto__Subtitle-s1a35ruo-2 cbqRVo">주연</div>
																								</div>
																								<div></div>
																							</div></a></li>
																					<li
																						...
																						lng="ko-KR"
																						class="InnerPartOfListWithImage__LinkSelf-s11a1hqv-1 gmbtJD"
																						title="박정민" href="/ko-KR/people/104081"><div
																								class="InnerPartOfListWithImage__ImageBlock-s11a1hqv-3 kXgAWr">
																								<div
																									class="ProfilePhoto__Self-s1v3isfu-1 cKevdV RoundedImageBlock-k5m4n5-0 gUZYtN">
																									<div
																										class="ProfilePhoto__ProfilePhotoImage-s1v3isfu-0 igTQYh"></div>
																									<div
																										class="ProfilePhoto__DefaultImageContainer-s1v3isfu-2 kPGxuy">
																										<img
																											class="defaultImage__ProfileImg-s1kn91bx-1 iaxVtx"
																							...
																							<div
																								class="InnerPartOfListWithImage__Info-s11a1hqv-5 ldfTUL">
																								<div
																									class="InnerPartOfListWithImage__Titles-s11a1hqv-4 jtpmaI">
																									<div
																										class="ListItemWithProfilePhoto__Title-s1a35ruo-1 cSGZfW">박정민</div>
																									<div
																										class="ListItemWithProfilePhoto__Subtitle-s1a35ruo-2 cbqRVo">주연</div>
																								</div>
																								<div></div>
																					...
																					<li
																						...
																						lng="ko-KR"
																						class="InnerPartOfListWithImage__LinkSelf-s11a1hqv-1 gmbtJD"
																						title="이재인" href="/ko-KR/people/339387"><div
																								class="InnerPartOfListWithImage__ImageBlock-s11a1hqv-3 kXgAWr">
																								<div
																									class="ProfilePhoto__Self-s1v3isfu-1 cKevdV RoundedImageBlock-k5m4n5-0 gUZYtN">
																									<div
																										class="ProfilePhoto__ProfilePhotoImage-s1v3isfu-0 rdgmJ"></div>
																									<div
																										class="ProfilePhoto__DefaultImageContainer-s1v3isfu-2 kPGxuy">
																										<img
																											class="defaultImage__ProfileImg-s1kn91bx-1 iaxVtx"
																							...
																							<div
																								...
																								<div
																									class="InnerPartOfListWithImage__Titles-s11a1hqv-4 jtpmaI">
																									<div
																										class="ListItemWithProfilePhoto__Title-s1a35ruo-1 cSGZfW">이재인</div>
																									<div
																										class="ListItemWithProfilePhoto__Subtitle-s1a35ruo-2 cbqRVo">주연</div>
																								</div>
																								<div></div>
																					...
																					<li
																						...
																						lng="ko-KR"
																						class="InnerPartOfListWithImage__LinkSelf-s11a1hqv-1 gmbtJD"
																						title="정진영" href="/ko-KR/people/225269"><div
																								class="InnerPartOfListWithImage__ImageBlock-s11a1hqv-3 kXgAWr">
																								<div
																									class="ProfilePhoto__Self-s1v3isfu-1 cKevdV RoundedImageBlock-k5m4n5-0 gUZYtN">
																									<div
																										class="ProfilePhoto__ProfilePhotoImage-s1v3isfu-0 ipXvad"></div>
																									<div
																										class="ProfilePhoto__DefaultImageContainer-s1v3isfu-2 kPGxuy">
																										<img
																											class="defaultImage__ProfileImg-s1kn91bx-1 iaxVtx"
																							...
																							<div
																								...
																								<div
																									class="InnerPartOfListWithImage__Titles-s11a1hqv-4 jtpmaI">
																									<div
																										class="ListItemWithProfilePhoto__Title-s1a35ruo-1 cSGZfW">정진영</div>
																									<div
																					...
																					<li
																						...
																						lng="ko-KR"
																						class="InnerPartOfListWithImage__LinkSelf-s11a1hqv-1 gmbtJD"
																						title="진선규" href="/ko-KR/people/260438"><div
																								class="InnerPartOfListWithImage__ImageBlock-s11a1hqv-3 kXgAWr">
																								<div
																									class="ProfilePhoto__Self-s1v3isfu-1 cKevdV RoundedImageBlock-k5m4n5-0 gUZYtN">
																									<div
																										class="ProfilePhoto__ProfilePhotoImage-s1v3isfu-0 hFlzDO"></div>
																									<div
																										class="ProfilePhoto__DefaultImageContainer-s1v3isfu-2 kPGxuy">
																										<img
																											class="defaultImage__ProfileImg-s1kn91bx-1 iaxVtx"
																							...
																							<div
																								...
																								<div
																									class="InnerPartOfListWithImage__Titles-s11a1hqv-4 jtpmaI">
																									<div
																										class="ListItemWithProfilePhoto__Title-s1a35ruo-1 cSGZfW">진선규</div>
																									<div
																										class="ListItemWithProfilePhoto__Subtitle-s1a35ruo-2 cbqRVo">조연</div>
																								</div>
																								<div></div>
																		...
																		<div class="Grid-zydj2q-0 cspjno">
																			<div class="Row-s1apwm9x-0 lowZpE">
																				<ul
																					...
																					<li class="HorizontalListItem-tt0z2b-0 hRbPKu"><div
																							...
																							<div
																								...
																								<div
																									...
																									<a lng="ko-KR"
																										...
																										title="백수골방" href="/ko-KR/users/DyKZx31lRv4dJ"><div
																											class="ProfilePhoto__Self-s1v3isfu-1 lniNjX RoundedImageBlock-k5m4n5-0 gUZYtN">
																											<div
																												class="ProfilePhoto__ProfilePhotoImage-s1v3isfu-0 kgJrze"></div>
																											<div
																												class="ProfilePhoto__DefaultImageContainer-s1v3isfu-2 kPGxuy">
																												<img
																													class="defaultImage__ProfileImg-s1kn91bx-1 iaxVtx"
																								...
																								<div
																									...
																									<img
																										...
																										width="16px" height="16px" alt="star"><span>4.5</span>
																								</div>
																							</div>
																							<div
																								...
																								<a lng="ko-KR"
																									class="StylelessLocalLink-s1aqpmgk-1 gdyQIs"
																									href="/ko-KR/comments/WzO2gApoqAQXZ"><div
																							...
																							<div
																								...
																								<span
																									...
																									width="18px" height="18px"></span><em>665</em><span
																									class="ContentlessCommentItem__ReplyImage-s1n6rtl6-3 gitnjq UIImg-s3jz6tx-0 hbSOwv"
																									...
																									width="18px" height="18px"></span><em>6</em>
																							</div>
																							<div
																							...
																							<div
																								...
																								<a lng="ko-KR"
																									...
																									href="/ko-KR/comments/69oMvny6VLMal"><div
																										...
																										<div
																											class="TextTruncate__Text-wvv1uj-1 gLsCNn"
																											style="white-space: pre-line;">묵직한 질문과
																											흥미로운 설정이 날개를 펴지 못한다.</div>
																									</div></a>
																							</div>
																							<div
																								class="ContentlessCommentItem__LikeReplyBlock-s1n6rtl6-1 bSwpdd">
																								<span
																									class="ContentlessCommentItem__LikeImage-s1n6rtl6-2 jmhzoz UIImg-s3jz6tx-0 jSJJRD"
																									src="data:image/svg+xml;base64,"
																									width="18px" height="18px"></span><em>465</em><span
																									class="ContentlessCommentItem__ReplyImage-s1n6rtl6-3 gitnjq UIImg-s3jz6tx-0 hbSOwv"
																									src="data:image/svg+xml;base64,"
																									width="18px" height="18px"></span><em>20</em>
																							</div>
																							<div
																								class="ContentlessCommentItem__UserActionBlock-s1n6rtl6-4 kJvkpH">
																								<button
																					...
																					<li class="HorizontalListItem-tt0z2b-0 hRbPKu"><div
																							...
																							<div
																								...
																								<div
																									...
																									<a lng="ko-KR"
																										class="StylelessLocalLink-s1aqpmgk-1 gdyQIs"
																										title="강성욱" href="/ko-KR/users/DyKZx3Keox4dJ"><div
																											class="ProfilePhoto__Self-s1v3isfu-1 lniNjX RoundedImageBlock-k5m4n5-0 gUZYtN">
																											<div
																												class="ProfilePhoto__ProfilePhotoImage-s1v3isfu-0 ceavpA"></div>
																											<div
																												class="ProfilePhoto__DefaultImageContainer-s1v3isfu-2 kPGxuy">
																												<img
																													class="defaultImage__ProfileImg-s1kn91bx-1 iaxVtx"
																							...
																							<div
																								...
																								<a lng="ko-KR"
																									class="StylelessLocalLink-s1aqpmgk-1 gdyQIs"
																									href="/ko-KR/comments/lP0E87WRGdQbx"><div
																										class="TextTruncate__Self-wvv1uj-0 iAyBuL">
																										<div
																											class="TextTruncate__Text-wvv1uj-1 gLsCNn"
																											style="white-space: pre-line;">내가 목사가 될
																											상인가? 관람후기...</div>
																									</div></a><span
																									class="ContentlessCommentItem__SpoilerText-s1n6rtl6-6 SGlQP">스포일러가
																									있어요!!
																									<button
																										class="ContentlessCommentItem__AcceptSpoilerButton-s1n6rtl6-7 jmpJzP StylelessButton-phxvo7-0 gsSopE"
																										aria-label="Accept Spoiler">&nbsp;보기</button>
																								</span>
																							</div>
																							<div
																								class="ContentlessCommentItem__LikeReplyBlock-s1n6rtl6-1 hkUbLO">
																								<span
																									class="ContentlessCommentItem__LikeImage-s1n6rtl6-2 jmhzoz UIImg-s3jz6tx-0 InTpX"
																									...
																									width="18px" height="18px"></span><em>436</em><span
																									class="ContentlessCommentItem__ReplyImage-s1n6rtl6-3 gitnjq UIImg-s3jz6tx-0 fsvLGh"
																							...
																							<div
																								class="ContentlessCommentItem__UserActionBlock-s1n6rtl6-4 kJvkpH">
																								<button
																									class="ContentlessCommentItem__UserActionButton-s1n6rtl6-5 gfwGvO StylelessButton-phxvo7-0 gsSopE">좋아요</button>
																							</div>
																						</div></li>
																					<div
