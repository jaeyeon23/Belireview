...
<link href="/brw/resources/css/bootstrap.css" rel="stylesheet">
...
<script>
   $(function(){
	   $('.r1').click(function(){
		   $('.titlegrade').attr('aria-expanded',"false");
		   $('.titlegrade').addClass('collapsed');
	        $('.r1').attr('aria-expanded',"true");
	        $('.r1').removeClass('collapsed');
	    })
	     $('.r2').click(function(){
		   $('.titlegrade').attr('aria-expanded',"false");
		   $('.titlegrade').addClass('collapsed');
	        $('.r2').attr('aria-expanded',"true");
	        $('.r2').removeClass('collapsed');
	    })
	    $('.r3').click(function(){
		   $('.titlegrade').attr('aria-expanded',"false");
		   $('.titlegrade').addClass('collapsed');
	        $('.r3').attr('aria-expanded',"true");
	        $('.r3').removeClass('collapsed');
	    })
   })
      ...
      <div class="App__Self-m1g4ja-0 iBpXSE">
         <div class="NavTabManager__NavContainer-dbid0l-0 hhxQev">
            ...
            <!-- 점수별 -->
                        ...
                        <section class="SectionWithHeader__Self-s1eyxltb-0 gAYeFO"><!-- 5점 -->
                           <div class="Grid-zydj2q-0 cspjno"  id="accordion" role="tablist" aria-multiselectable="true">
                              <div class="Row-s1apwm9x-0 lowZpE">
                                 <header class="SectionWithHeader__Header-s1eyxltb-1 cuiACK" role="tab" id="headingOne">
                                    <h3 class="SectionWithHeader__Title-s1eyxltb-2 kwjefp panel-title SectionWithHeader__Title-s1eyxltb-2" >
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="collapsed r${i} titlegrade">${rating}점 준 영화</a></h3>
                           ...
                           <div class="PrimitiveHorizontalScrollable__ScrollBarContainer-hy4esm-0 hUyjJn">
                              <section class="SectionWithShrinkHeaderAndTabs__TabContentsContainer-tt2x7j-0 dnkVDn">
                                 <div class="HideableBlock__Self-ikumnu-0 hgPHZk">
                                    <section   class="ArchiveRatingsPage__AllSection-s1ojhyk5-0 fMnTHB">
                                       <div class="Grid-zydj2q-0 cspjno panel-collapse collapse out" id="collapseOne" 
                                 role="tabpanel" aria-labelledby="headingOne">
                                          <div class="Row-s1apwm9x-0 lowZpE panel-body ">
