					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li>
									<c:if test="${sessionScope.ID != null }">
										<a href="#"> <c:if test="${sessionScope.PROFILE_IMAGE == null }">
									...
									<div>
										<form class="side-search">
											<div class="input-group">
												<input type="text" id="ttautocompleteText"
													class="form-control search-wid" placeholder="Search Here"
													aria-describedby="basic-addon1"> <a href=""
													class="input-group-addon btn-side-serach" id="basic-addon1"><i
					...
					<form class="side-search">
						<div class="input-group">
							<input type="text" name="searchText"
								class="form-control search-wid" id="autocompleteText" placeholder="Search Here"
