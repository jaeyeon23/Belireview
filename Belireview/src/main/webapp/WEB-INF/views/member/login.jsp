	...
	<div id="container">
		...
		<div id="content">
			<div class="title" aria-live="assertive">
				...
				<form id="login_form" method="post" action="/brw/member/login.br">
				<fieldset class="login_form">
                    ...
                    <div class="join_row">
                        <span class="ps_box int_pass" id="pswd1Img">
							<input type="password" id="password" name="pw" class="int" title="비밀번호 입력" aria-describedby="pswd1Msg" maxlength="20" placeholder="비밀번호">
					...
					<div class="btn_area">
					<button type="submit" id="로그인" value="로그인" class="btn_type btn_primary"><span>로그인</span></button>
					</div>
				</fieldset>
			</form>
			...
			<div class="position_a">
				<div class="find_info">
					<center>
					<a href="http://localhost:8085/bwr/member/findId.br">아이디 찾기</a> 
						<span class="bar" aria-hidden="true">|</span> 
					<a href="http://localhost:8085/bwr/member/findPw.br">비밀번호 찾기</a> 
					<span class="bar" aria-hidden="true">|</span> 
